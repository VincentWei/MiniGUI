...
%break_mappings =
    (
     'AI' => "UCHAR_BREAK_AMBIGUOUS",
     'AL' => "UCHAR_BREAK_ALPHABETIC",
     'B2' => "UCHAR_BREAK_BEFORE_AND_AFTER",
     'BA' => "UCHAR_BREAK_AFTER",
     'BB' => "UCHAR_BREAK_BEFORE",
     'BK' => "UCHAR_BREAK_MANDATORY",
     'CB' => "UCHAR_BREAK_CONTINGENT",
     'CJ' => "UCHAR_BREAK_CONDITIONAL_JAPANESE_STARTER",
     'CL' => "UCHAR_BREAK_CLOSE_PUNCTUATION",
     'CM' => "UCHAR_BREAK_COMBINING_MARK",
     'CP' => "UCHAR_BREAK_CLOSE_PARANTHESIS",
     'CR' => "UCHAR_BREAK_CARRIAGE_RETURN",
     'EB' => "UCHAR_BREAK_EMOJI_BASE",
     'EM' => "UCHAR_BREAK_EMOJI_MODIFIER",
     'EX' => "UCHAR_BREAK_EXCLAMATION",
     'GL' => "UCHAR_BREAK_NON_BREAKING_GLUE",
     'H2' => "UCHAR_BREAK_HANGUL_LV_SYLLABLE",
     'H3' => "UCHAR_BREAK_HANGUL_LVT_SYLLABLE",
     'HL' => "UCHAR_BREAK_HEBREW_LETTER",
     'HY' => "UCHAR_BREAK_HYPHEN",
     'ID' => "UCHAR_BREAK_IDEOGRAPHIC",
     'IN' => "UCHAR_BREAK_INSEPARABLE",
     'IS' => "UCHAR_BREAK_INFIX_SEPARATOR",
     'JL' => "UCHAR_BREAK_HANGUL_L_JAMO",
     'JT' => "UCHAR_BREAK_HANGUL_T_JAMO",
     'JV' => "UCHAR_BREAK_HANGUL_V_JAMO",
     'LF' => "UCHAR_BREAK_LINE_FEED",
     'NL' => "UCHAR_BREAK_NEXT_LINE",
     'NS' => "UCHAR_BREAK_NON_STARTER",
     'NU' => "UCHAR_BREAK_NUMERIC",
     'OP' => "UCHAR_BREAK_OPEN_PUNCTUATION",
     'PO' => "UCHAR_BREAK_POSTFIX",
     'PR' => "UCHAR_BREAK_PREFIX",
     'QU' => "UCHAR_BREAK_QUOTATION",
     'RI' => "UCHAR_BREAK_REGIONAL_INDICATOR",
     'SA' => "UCHAR_BREAK_COMPLEX_CONTEXT",
     'SG' => "UCHAR_BREAK_SURROGATE",
     'SP' => "UCHAR_BREAK_SPACE",
     'SY' => "UCHAR_BREAK_SYMBOL",
     'WJ' => "UCHAR_BREAK_WORD_JOINER",
     'XX' => "UCHAR_BREAK_UNKNOWN",
     'ZW' => "UCHAR_BREAK_ZERO_WIDTH_SPACE",
     'ZWJ' => "UCHAR_BREAK_ZERO_WIDTH_JOINER"
     );
...
sub print_row
{
    ...
    if ($flag)
    {
	return $values[0] . " + UCHAR_MAX_TABLE_INDEX";
    }
...
sub handle_decomp ($$$$)
{
    ...
    my $offset = "UCHAR_NOT_PRESENT_OFFSET";
...
sub print_decomp
{
    ...
    print OUT "#define UCHAR_NOT_PRESENT_OFFSET $NOT_PRESENT_OFFSET\n\n";

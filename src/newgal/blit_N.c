/*
**  $Id: blit_N.c 11758 2009-06-14 05:34:28Z weiym $
**  
...
static void Blit_RGB888_index8(GAL_BlitInfo *info)
{
...
static void Blit_RGB888_RGB555(GAL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
    int c;
#endif
...
static void Blit_RGB888_RGB565(GAL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
    int c;
#endif
...
#endif
static void Blit_RGB565_32(GAL_BlitInfo *info, const Uint32 *map)
{
#ifndef USE_DUFFS_LOOP
    int c;
#endif
...
static void Blit_RGB565_ARGB8888(GAL_BlitInfo *info)
{
...
static void Blit_RGB565_ABGR8888(GAL_BlitInfo *info)
{
...
static void Blit_RGB565_RGBA8888(GAL_BlitInfo *info)
{
...
static void Blit_RGB565_BGRA8888(GAL_BlitInfo *info)
{
...
#endif
static void Blit_RGB888_index8_map(GAL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
    int c;
#endif
...
static void BlitNto1(GAL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
    int c;
#endif
...
static void BlitNtoN(GAL_BlitInfo *info)
{

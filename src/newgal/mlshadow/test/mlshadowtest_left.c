/* 
 ** $Id: mlshadowtest_left.c 8819 2007-12-27 03:24:54Z xwyan $
 **
 ** Listing 20.1
 **
...
void create_surface(int i)
{
    ...
    if((ret = LoadBitmapFromFile(HDC_SCREEN, (PBITMAP)&bmpinfo[i], bmp_path[i])) == ERR_BMP_OK){
        ...
        mlsSetSlaveScreenInfo(slave_hdc[i], MLS_INFOMASK_OFFSET, _x_step1*i+20, 250, 0, 0, 0, 0);
...
int MiniGUIMain (int argc, const char* argv[])
{
	...
	JoinLayer(NAME_DEF_LAYER , "mlshadowtestleft" , 0 , 0);
#endif
